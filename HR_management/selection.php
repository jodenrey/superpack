                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="actionDropdown<?php echo $app['id']; ?>">
                                                    ...
                                                    <?php if (!empty($app['resume_path'])): ?>
                                                        <li>
                                                            <a class="dropdown-item" href="<?php echo htmlspecialchars($app['resume_path']); ?>" target="_blank">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <?php if (!empty($app['resume_path'])): ?>
                                                        <div class="mt-3">
                                                            <a href="<?php echo htmlspecialchars($app['resume_path']); ?>" class="btn btn-outline-primary" target="_blank">
                                                                <i class="fas fa-file-alt me-2"></i> View Resume
                                                            </a>
                                                        </div>
                                                    <?php endif; ?>
